  ...
  const news = [
    ...
    },
    {
      ...
      fullContent: `
        ...
        <p>Esta comemoração contou com momentos inesquecíveis, marcados pela presença da Banda da Brigada Militar, do PFI (Projeto Filhos de Issacar), do Exército de Débora e das Divas da Alegria, que trouxeram música, emoção e alegria a todos os presentes.
