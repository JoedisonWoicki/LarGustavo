      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {donationMethods.map((method, index) => (
            <div key={index} className="glass-dark p-6 rounded-xl shadow-2xl hover-lift interactive-card animate-scale-in" style={{animationDelay: `${index * 0.1}s`}}>
              <div className="bg-gradient-to-r from-[#6c70e5] to-purple-500 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse-glow">
              ...
              <ul className="space-y-1">
                {method.details.map((detail, detailIndex) => (
                  <li key={detailIndex} className="flex items-center gap-2 text-xs">
                    <div className="w-1.5 h-1.5 bg-gradient-to-r from-[#6c70e5] to-purple-400 rounded-full flex-shrink-0 animate-pulse-glow"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="glass p-6 rounded-xl text-white shadow-2xl hover-lift">
              <div className="flex items-center gap-3 mb-4">
                <div className="bg-gradient-to-r from-[#6c70e5] to-purple-500 w-12 h-12 rounded-full flex items-center justify-center animate-pulse-glow">
              ...
              <div className="bg-white p-4 rounded-lg mb-4 text-center">
                ...
                />
                <p className="text-[#6c70e5] text-sm font-semibold">
            ...
            <div className="glass p-8 rounded-xl text-white shadow-2xl hover-lift">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="bg-gradient-to-r from-[#6c70e5] to-purple-500 w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold animate-pulse-glow">
                    1
                  </div>
                  <div>
        ...
        <div className="mt-16 glass-dark p-8 rounded-xl shadow-2xl hover-lift animate-fade-in-up">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="bg-gradient-to-r from-[#6c70e5] to-purple-500 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 animate-pulse-glow">
