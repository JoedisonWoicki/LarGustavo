        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 animate-fade-in-up">
            ...
            <ul className="space-y-2">
              <li><a href="#inicio" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Início</a></li>
              <li><a href="#sobre" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Sobre Nós</a></li>
              <li><a href="#servicos" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Serviços</a></li>
              <li><a href="#equipe" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Equipe</a></li>
              <li><a href="#comunicacao" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Comunicação</a></li>
              <li><a href="#apoiadores" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Apoiadores</a></li>
              <li><a href="#doacoes" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Como Doar</a></li>
              <li><a href="#trabalhe-conosco" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Trabalhe Conosco</a></li>
              <li><a href="#transparencia" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Transparência</a></li>
              <li><a href="#feedback" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Feedback</a></li>
              <li><a href="#contato" className="text-slate-300 hover:text-[#29478f] transition-colors hover-glow">Contato</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-1 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-slate-300 hover-glow">
                <Phone size={16} className="text-[#29478f] animate-pulse-glow" />
                <span>(51) 3386-1125</span>
              </div>
              <div className="flex items-center gap-2 text-slate-300 hover-glow">
                <Mail size={16} className="text-[#29478f] animate-pulse-glow" />
                <span>contato@largustavonordlund.com.br</span>
              </div>
              <div className="flex items-start gap-2 text-slate-300 hover-glow">
                <MapPin size={16} className="mt-1 text-[#29478f] animate-pulse-glow" />
...
Porto Alegre, RS  CEP 91270-450</span>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 text-center animate-fade-in-up">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-white">
              Feito com <Heart className="inline text-[#29478f] animate-pulse-glow" size={16} /> para cuidar de quem você ama
            </div>
          </div>
        </div>
      </div>
